...
var blower;
var starDisplay; 
var emptystarImg,oneStarImg, twoStarImg
function preload()
{
...
twoStarImg= loadImage('stars.png');
...
function setup() 
{
  ...
  starDisplay.addAnimation('stars',twoStarImg);
